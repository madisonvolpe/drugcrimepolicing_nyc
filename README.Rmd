...
* si_drugs - all drug arrests from 2013-2018 that have taken place on Staten Island (used - NYPD Arrest Data YTD + NYPD Arrest Data Historic)
...
* We have conducted exploratory spatial analysis in both QGIS + R - making maps overlaying arrests with racial makeups of NTA, CT. See *Maps* for QGIS analysis, see *ea_Arrests* in scripts for R analysis! :white_check_mark:
